import{t as e}from"./modulepreload-polyfill-BDH-tZZC.js";import{c as t,f as n,i as r,n as i,p as a,s as o,t as s,u as c}from"./products-BlNQRWXO.js";/* empty css                 */e((()=>{a(),t(),i();var e=document.querySelector(`.js-expand-menu-btn`),l=document.querySelector(`.js-mobile-menu`);e&&l&&e.addEventListener(`click`,()=>{l.classList.toggle(`mobile-menu-expanded`)}),s(u),o().then(e=>{let t=document.querySelector(`.js-cart-quantity-ld`),n=document.querySelector(`.js-cart-quantity-sd`),r=c(e);t.innerText=r.toString(),n.innerText=r.toString()}),console.log(`got products`);function u(e){let t=document.querySelector(`.js-products-row`),i=e.map(e=>`
      <div class="col">
        <article class="card">
