import{r as e,t}from"./modulepreload-polyfill-DvoRgtBb.js";/* empty css                 */import{t as n}from"./dayjs.min-og6vcfpW.js";import{n as r,r as i}from"./orders-data-Bipqt2du.js";t((()=>{i();var t=e(n());r(l),console.log(localStorage.getItem(`kamnaProducts`)),console.log(localStorage.getItem(`kaamnaOptions`));var a=localStorage.getItem(`kamnaProducts`)||`[]`,o=JSON.parse(a),s=localStorage.getItem(`kaamnaOptions`)||`[]`,c=JSON.parse(s);function l(e){let n=e.map(e=>{let n=e.orderTime;return`
